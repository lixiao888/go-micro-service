...
import (
	...
	go_micro_service_payment "git.imooc.com/coding-447/payment/proto/payment"
	"git.imooc.com/coding-447/paymentApi/handler"
	...
	paymentApi "git.imooc.com/coding-447/paymentApi/proto/paymentApi"
)
...
func main() {
	...
	// jaeger 链路追踪
	t,io,err := common.NewTracer("go.micro.api.payment","10.4.7.71:6831")
	if err !=nil {
		common.Error(err)
	}
	defer io.Close()
